        ...
        if (exists) {
          uiHtml += `
            <div style="display:flex; gap:8px;">
              <a href="../fichas/visor.html?v=2&file=${encodeURIComponent(fileUrl + '?t=' + Date.now())}" target="_blank" class="btn-guardar" style="flex:1; background:#3b82f6; text-align:center; text-decoration:none;">VER PDF</a>
