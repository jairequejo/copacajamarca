...
async function fetchAndRender(isSilent = false) {
    ...
    try {
        ...
        if (!isSilent) {
            ...
            emptyState.innerHTML = '<img src="logo.svg" style="width: 64px; opacity: 0.3; margin: 0 auto 12px; display: block;"> <p>No se pudo cargar la información</p>';
...
function renderMatches() {
    ...
    if (filtered.length === 0) {
        matchesList.innerHTML = '';
        emptyState.innerHTML = '<img src="logo.svg" style="width: 72px; opacity: 0.25; margin: 0 auto 16px; display: block;"> <p>Sin partidos con estos filtros</p>';
        emptyState.hidden = false;
        return;
    }
...
const _logo=new Image();_logo.src='logo.svg';_logo.crossOrigin='anonymous';
